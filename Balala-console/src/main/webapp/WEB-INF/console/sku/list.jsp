...
<head>
    ...
    <script type="text/javascript">
        ...
        function addSku(skuId) {
            ...
            var params = {"marketPrice": m, "price": p, "deliveFee": f, "stock": s, "upperLimit": l, "id": skuId};
            // 异步保存数据到数据库中
            ...
            <c:forEach items="${skus}" var="sku">
                <tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
                    ...
                    <td align="center"><input type="text" id="p${sku.id }" value="${sku.price}" disabled="disabled"
                                              size="10"/></td>
                    <td align="center"><input type="text" id="s${sku.id }" value="${sku.stock}" disabled="disabled"
                                              size="10"/></td>
